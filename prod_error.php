...
<div id="plant" class="contact_us layout_padding">
    <div class="container">
        <div class="row">
            <div class="col-md-12 ">
                <div class="titlepage">
                    <h2 style="text-align: center; margin-top: 45px;">Fallo en la inserción</h2>
                    <span style="text-align: center;"><a class='btn btn-primary' href="<?=$_SERVER["HTTP_REFERER"]?>">Volver</a></span><br>
                </div>
            </div>
        </div>
    </div>
