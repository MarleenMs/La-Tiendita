...
<div id="plant" class="contact_us layout_padding">
         <div class="container">
            <div class="row">
               <div class="col-md-12 ">
                  <div class="titlepage">
                     <h2 style="text-align: center; margin-top: 45px;">Contáctanos</strong></h2>
                     <span style="text-align: center;">¡Gracias por enviar tus datos!<br>Muy pronto recibiras respuesta de parte de La Tienda Online</span>
                  </div>
               </div>
            </div>
         </div>
